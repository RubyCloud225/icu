...
prefix = /Users/catherinepemblington/icu-install
exec_prefix = ${prefix}
...
SO_TARGET_VERSION = 78.0.1
SO_TARGET_VERSION_MAJOR = 78
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt78
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt78 
ICUDATA_CHAR = l
...
CPPFLAGS =  $(THREADSCPPFLAGS)  -DU_HAVE_STRTOD_L=1 -DU_HAVE_XLOCALE_H=1 
